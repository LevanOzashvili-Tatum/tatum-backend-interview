...
const ethSDK = TatumEthSDK({
  apiKey: 't-64de071f946f4c001cc79641-64de0720143e73001c21f649',
});
...
export async function ethErc20Example() {
  ...
  const senderAddress = '0x2be3e0a7fc9c0d0592ea49b05dde7f28baf8e380';
  ...
  const receiverPrivateKey =
    '0x14f391a24ebb50e9792362750429c178c7702e5d00ac7fb3d27d58e85ea1c0e8';
